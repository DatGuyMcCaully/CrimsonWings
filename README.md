...
Usage
Pre-built EXE
Download CrimsonWings.exe from Releases

Close Crimson Desert

Run CrimsonWings.exe

The game folder will be detected automatically — if not, click Browse or Scan Drives
